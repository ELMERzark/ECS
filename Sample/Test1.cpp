...
void Test1::TestEcs()
{
	...
	*/
	...
	std::cout << "º‰∏Ù ∫¡√Î1:" << duration << std::endl;
	...
	std::cout << "º‰∏Ù ∫¡√Î2:" << duration << std::endl;
	...
	mgr.runAllTasks();
	duration = CaculateTime(2, start);
	std::cout << "º‰∏Ù ∫¡√Î3:" << duration << std::endl;
	...
	mgr.runAllTasks();
	duration = CaculateTime(2, start);
	std::cout << "º‰∏Ù ∫¡√Î6:" << duration << std::endl;
	...
	duration = CaculateTime(2, start);
	std::cout << "º‰∏Ù ∫¡√Î4:" << duration << std::endl;
	...
	duration = CaculateTime(2, start);
	std::cout << "º‰∏Ù ∫¡√Î5:" << duration << std::endl;
